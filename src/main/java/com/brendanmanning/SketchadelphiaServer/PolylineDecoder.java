...
// Copied from https://github.com/scoutant/polyline-decoder/
...
public class PolylineDecoder {
    ...
    public List<Coordinates> decode(String encoded) {
     ...
     * @return
     */
    public List<Coordinates> decode(String encoded, double precision) {
        ...
        while (index < encoded.length()) {
            ...
            Coordinates p = new Coordinates((double) lat / precision, (double) lng / precision);
            track.add(p);
        }
        return track;
    }
